            ...
            <div className=" row px-3 pt-5">
              <div className="col-md-3 col-12 text-start mb-0">
                ...
                <div className="d-flex">
                  ...
                  {isEditing === "footer_title" ? (
                    ...
                    <h4 className="mx-2 mt-2 fw-bold">
                      {apiData.footer_title}
                      <button
              ...
              <div className="col-md-3 col-12  mb-0 text-start">
                ...
                <div className="row ">
                  ...
                  <div className="col ps-0">
                    <p className="fw-light text-start ms-1">
                      support@figma.com
                    </p>
                  </div>
                </div>
                    ...
                    <div className="d-flex flex-wrap gap-2 ">
                      <div>
                        ...
                        {!isEditing && (
                          <span
                            className="text-secondary"
                            onClick={() => handleEditClick("fb_link")}
                          >
                            <FaEdit />
                          </span>
                        )}
                      ...
                      <div>
                        ...
                        {!isEditing && (
                          <span
                            className="text-secondary"
                            onClick={() => handleEditClick("insta_link")}
                          >
                            <FaEdit />
                          </span>
                        )}
                      ...
                      <div>
                        ...
                        {!isEditing && (
                          <span
                            className="text-secondary"
                            onClick={() => handleEditClick("twitter_link")}
                          >
                            <FaEdit />
                          </span>
                        )}
                      ...
                      <div>
                        ...
                        {!isEditing && (
                          <span
                            className="text-secondary"
                            onClick={() => handleEditClick("linkedin_link")}
                          >
                            <FaEdit />
                          </span>
                        )}
                      ...
                      <div>
                        ...
                        {!isEditing && (
                          <span
                            className="text-secondary"
                            onClick={() => handleEditClick("whatsapp_link")}
                          >
                            <FaEdit />
                          </span>
                        )}
