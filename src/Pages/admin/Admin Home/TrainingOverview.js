                    ...
                    <div className='container trainingOverview mt-3'>
                        <div className='row d-flex'>
                            ...
                            {isEditing === 'title' ? (
                                ...
                                <h1 className='secondheading text-start mb-3'>{datas?.title}
                                    <FaEdit size={20} onClick={() => handleEditClick("title")} className="text-secondary mx-2" />
                                </h1>
                            )}
                            ...
                            <div className='col-md-8'>
                                {isEditing === 'description' ? (
                                    ...
                                    <p className='text-start paraContent'>{datas?.description}
                                        <FaEdit size={20} onClick={() => handleEditClick("description")} className="text-secondary mx-2" />
                                    </p>
                                )}
                            </div>
                                ...
                                <div className='row d-flex'>
                                    <div className='col-md-8'>
                                        ...
                                        {isEditing === 'contact_no' ? (
                                            ...
                                            <h3>{datas?.contact_no}
                                                <FaEdit size={20} onClick={() => handleEditClick("contact_no")} className="text-secondary ms-2 mb-2" />
                                            </h3>
                                        )}
                                        <p>Toll Free No</p>
                                    </div>
                    ...
                    <div className="container PointsSection py-4">
                        <div className="points-container row">
                            {formik.values.key_points.map((point, index) => (
                                <div className="point-item col-md-3 mb-3 d-flex align-items-center" key={index}>
                                    <img src={CirclePoints} className='me-2' alt='circleImg' style={{ width: "30px", height: "30px" }} />
                                    ...
                                    {isEditing === 'key_points' && (
                                        <FaTrash onClick={() => handleDeletePoint(index)} className="text-danger ms-2" />
                                    )}
                                </div>
                            ))}
                        </div>
                        {isEditing === 'key_points' ? (
                            <>
                                {isAddingPoint && (
                                    <div className="text-start col-md-4 mt-2 d-flex align-items-center">
                                        ...
                                        />
                                        <FaTimes onClick={() => setIsAddingPoint(false)} className="text-danger ms-2" />
                                    </div>
                                )}
                                <div className="d-flex justify-content-center mt-3">
                                    <FaPlus className='text-success' onClick={() => setIsAddingPoint(true)} />
                                    <FaSave
                                        onClick={() => {
                                            if (newPoint.trim()) {
                                                handleAddPoint();
                            ...
                            <div className="mt-3 d-flex justify-content-center">
                                <FaEdit size={20} onClick={() => handleEditClick("key_points")} className="text-secondary mx-2" />
                            </div>
                        )}
                    </div>
                </div>
