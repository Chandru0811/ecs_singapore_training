                        ...
                        <div className="container-fluid row mt-3">
                            <div className="col-lg-7">
                                ...
                                {isEditing === 'title' ? (
                                    <div className="d-flex">
                                        ...
                                        />
                                        <FaSave onClick={handleSaveClick} className="text-primary mx-2 mt-2" />
                                        <FaTimes onClick={handleCancel} className="text-danger mt-2" />
                                    </div>
                                ) : (
                                    <h1 className="display-5 text-start fw-bold">{formik.values.title}
                                        <FaEdit size={20} onClick={() => handleEditClick('title')} className="text-secondary ms-3" />
                                    </h1>
                                )}
                                {isEditing === 'description' ? (
                                    <div className="d-flex">
                                        <textarea
                                            ...
                                            className="form-control mb-2"
                                        />
                                        <FaSave onClick={handleSaveClick} className="text-primary mx-2 mt-4" />
                                        <FaTimes onClick={handleCancel} className="text-danger mt-4" />
                                    </div>
                                ) : (
                                    <p className="text-start">{formik.values.description}
                                        <FaEdit size={20} onClick={() => handleEditClick('description')} className="text-secondary ms-3" />
                                    </p>
                                )}
                            ...
                            <div className="col-lg-5">
                                {isEditing === 'image_path' ? (
                                    ...
                                    <FaEdit size={20} onClick={() => handleEditClick('image_path')} className="text-secondary" />
                                )}
                                <div>
                                    <img src={`${ImageURL}${heroData?.image_path}`} className='img-fluid' alt={heroData?.title} />
                                </div>
                            </div>
                            {/* Cards */}
                                ...
                                <div className='card-body'>
                                    <div className='row d-flex pt-3'>
                                        <div className='col-md-4 d-flex justify-content-center'>
                                            <img src={formik.values.herocardImg1} alt='BookImg' className='me-2' style={{ width: "30px", height: "30px" }} />
                                            {isEditing === 'subcontent_1' ? (
                                                ...
                                                <p>{formik.values.subcontent_1}
                                                    <FaEdit onClick={() => handleEditClick('subcontent_1')} className="text-secondary mx-2" />
                                                </p>
                                            )}
                                        </div>
                                        <div className='col-md-4 d-flex justify-content-center'>
                                            <img src={formik.values.herocardImg2} className='me-2' alt='BookImg' style={{ width: "30px", height: "30px" }} />
                                            {isEditing === 'subcontent_2' ? (
                                                ...
                                                <p>{formik.values.subcontent_2}
                                                    <FaEdit onClick={() => handleEditClick('subcontent_2')} className="text-secondary mx-2" />
                                                </p>
                                            )}
                                        </div>
                                        <div className='col-md-4 d-flex justify-content-center'>
                                            <img src={formik.values.herocardImg3} className='me-2' alt='BookImg' style={{ width: "30px", height: "30px" }} />
                                                ...
                                                <>
                                                    <div className="d-flex">
                                                        <input
                                                            ...
                                                            className="form-control"
                                                        />
                                                        <FaSave onClick={handleSaveClick} className="text-primary mt-2 mx-2" />
                                                        <FaTimes onClick={handleCancel} className="text-danger mt-2" />
                                                    </div>
                                                </>
                                            ) : (
                                                <p>{formik.values.subcontent_3}
