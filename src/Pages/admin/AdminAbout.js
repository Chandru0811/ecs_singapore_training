...
function AdminAbout() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      images.forEach((image) => {
        if (
          values[image] instanceof ArrayBuffer ||
  ...
  const publishData = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        toast.success(
          response.data.message || "About Changes Published Successfully!"
        );
                                    ...
                                    {isEditing === "image_1" ? (
                                      <div>
                                        ...
                                        <input
                                          ...
                                          value={
                                            formik.values.image1_description
                                          }
                                          onChange={formik.handleChange}
                                          className="form-control mb-2"
                                        />
                                    ...
                                    {isEditing === "image_2" ? (
                                      <div>
                                        ...
                                        <input
                                          ...
                                          value={
                                            formik.values.image2_description
                                          }
                                          onChange={formik.handleChange}
                                          className="form-control mb-2"
                                        />
                                    ...
                                    {isEditing === "image_3" ? (
                                      <div>
                                        ...
                                        <input
                                          ...
                                          value={
                                            formik.values.image3_description
                                          }
                                          onChange={formik.handleChange}
                                          className="form-control mb-2"
                                        />
