...
const HeaderFooter = ({ handleLogin }) => {
  ...
  return (
    <div className="container-fluid px-0 pt-2">
      <div >
      <div className="card-header d-flex align-items-center px-0 py-2 mb-2 bg-light">
      ...
      <div className="" style={{marginTop:"5rem"}}>
        <div className="card-header d-flex align-items-center py-2  mb-2 bg-light">
          ...
          <div className=" row px-3 pt-5">
            <div className="col-md-3 col-12  mb-0 ">
              ...
              <p className="fw-light text-start">
                Hi! My name is Dmitrii Rogozza and I’m an expert in web design
