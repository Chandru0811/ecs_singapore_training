      ...
      <div className='row mt-3'>
        <div className='col-lg-7'>
          ...
          <div className='text-start'>
            ...
            <div className='mt-4'>
              <button type="button" className='btn btn-primary btn-lg mr-3'>Get Started</button>
              <button type="button" className='mx-2 btn btn-outline-primary btn-lg'>Learn More</button>
            </div>
          </div>
        </div>
              ...
              <div className='card p-4 enquiryform'>
                <div className='row mb-3'>
                  <div className='col-md-6 text-start'>
                    ...
                    <input
                      type='text'
                      className={`form-control homeInput ${formik.touched.firstName && formik.errors.firstName ? "is-invalid" : ""}`}
                  ...
                  <div className='col-md-6 text-start'>
                    ...
                    <input
                      type='text'
                      className={`form-control homeInput ${formik.touched.lastName && formik.errors.lastName ? "is-invalid" : ""}`}
                ...
                <div className='row mb-3'>
                  <div className='col-md-6 text-start'>
                    ...
                    <input
                      type='email'
                      className={`form-control homeInput ${formik.touched.email && formik.errors.email ? "is-invalid" : ""}`}
                  ...
                  <div className='col-md-6 text-start'>
                    ...
                    <input
                      type='number'
                      className={`form-control homeInput ${formik.touched.phoneNumber && formik.errors.phoneNumber ? "is-invalid" : ""}`}
