...
function UserCourse() {
  ...
  const renderContent = () => {
    const activeCategory = categoryData.find(category => category.id === activeTab);
                      ...
                      <div className="card-content container-fluid px-0">
                        ...
                        >
                          <div className="heading-content py-2 d-flex justify-content-between">
                            <h5 className="text-light fw-bold">CloudeECS</h5>
                          ...
                          >
                            ...
                            <div className="text-start">
                              <p className="fw-medium">
                                Training Mode : <span className="fw-light">Online</span>
                              </p>
                              <p>
                                ${parseFloat(card.offer_price).toFixed(2)}&nbsp;&nbsp;&nbsp;
                                <del className="fw-light">${parseFloat(card.price).toFixed(2)}</del>
                                &nbsp;&nbsp;&nbsp;
                                <span className="rounded bg-primary p-1 text-light">
                                  {calculateDiscountPercentage(card.price, card.offer_price).toFixed(0)}% off
                                </span>
                              </p>
                            </div>
    ...
    <section>
      ...
      <div className="container-fluid">
        {courseData?.courses && courseData.courses.length > 0 ? (
          <>
            <h3 className="text-start fw-bold ms-2 mb-0">{courseData.title}</h3>
                  ...
                  >
                    <div key={card.id}>
                      <div className="card-content container-fluid px-0">
                        ...
                        >
                          <div className="heading-content py-2 d-flex justify-content-between">
                            <h5 className="text-start ms-2 text-light fw-bold">CloudECS</h5>
                            <div className="rating text-light">
                              <span>
                                {[...Array(4)].map((_, starIndex) => (
                                  <IoIosStar
        ...
        <div className="custom-tabs mt-5">
          <div className="row tabs-header">
            {categoryData.map((category) => (
              <div key={category.id} className="col-6 col-md-3 col-lg-2 py-2">
                <button
                  className={`w-100 ${activeTab === category.id ? "active" : ""}`}
